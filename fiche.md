...
## Contexte
La région Auvergne Rhône-Alpes veux une application web qui liste les artisans et qui permet au particulier et au profésionnel de prendre contacte avec eux.
...
Des changements ont était aporter en cours de route notament sur le fond qui fus changer pour être en accord avec la [page officiel de l'Auvergne Rhône-Alpes](https://www.auvergnerhonealpes.fr/contenus/ladministration-regionale-et-les-offres-demploi).
...
Des probleme pour le formulaire de contact, tout les service que j'ai trouver étant payant et n'ayant trouver uniquement des méthodes qui nécésité une seul adresse de contact j'ai opté pour un `mailto` qui ouvre la méssagerie avec l'adresse de l'artisan.  
...
### Sécurité
Il n'y a pas de systhème de connection pour les particuliers car la notation n'était pas dans le cayer des charge. 
